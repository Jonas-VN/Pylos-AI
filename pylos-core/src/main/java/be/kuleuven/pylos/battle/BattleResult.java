...
public class BattleResult {
    ...
    public BattleResult(PylosPlayerType p1, PylosPlayerType p2, long runTime, int p1StartP1Wins, int p1StartDraws, int p1StartP2Wins, int p2StartP1Wins, int p2StartDraws, int p2StartP2Wins) {
        this.p1 = p1;
        this.p2 = p2;
    ...
    public static BattleResult merge(Collection<BattleResult> brs) {
        ...
        return new BattleResult(p1, p2, runTime, p1StartP1Wins, p1StartDraws, p1StartP2Wins, p2StartP1Wins, p2StartDraws, p2StartP2Wins);
    }
